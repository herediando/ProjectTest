<?php
	...
	include("conexion.php");
      ...
      if(mysql_num_rows($resultado)==0)
          {
       echo "<script> alert('Nombre del comercio no existe, Por Favor Verificar'); history.go(-1)</script>";
       die;
       }   
...
<div class="container">
      <legend class="text-center header">Consulta Comercio</legend>
        ...
        <div class="form-group col-md-3"> <!-- Comercio -->
          <label for="full_name_id" class="control-label">C&oacute;digo del Comercio</label>
            <input type="number" class="form-control" id="codigo_comercio " name="codigo_comercio " value="<?php echo $codigo_comercio ?>" disabled>
        </div>
        <div class="form-group col-md-3"> <!-- Comercio -->
...
<div class="form-group col-md-3"> <!-- Zip Code-->
        ...
        <div class="form-group col-lg-offset-4 col-lg-10"> 
            ...
            <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove-sign" disable></span>      ELIMINAR COMERCIO</button>
        </div> 
    </div>
</form>
